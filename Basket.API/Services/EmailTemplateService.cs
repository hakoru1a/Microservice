...
namespace Basket.API.Services
{
    public class EmailTemplateService
    {
        ...
        protected BackgroundJobSettings _backgroundJobSetting;

        public EmailTemplateService(BackgroundJobSettings backgroundJobSetting)
        {
            _backgroundJobSetting = backgroundJobSetting;
        }
